...
```
```bash
python predict.py --input "GGGCCCGUAGUCUCAGGGUAAGAGCACACGCUGAAGUGUGUGGGUCGGCAGUUCGAUCCCGCUGCGGCCCACCA" --seq_name "tRNA_example" --weight_path ./weight/trian_alldata.pt --output_dir ./my_results --gpu_id 0
```
